...
Translate the operator's supplied skill arguments into the command, then run `python3 scripts/workflow.py defer-job ...` (for example `--title "..." --reason "..." --trigger "..." --source P1.S1`).
