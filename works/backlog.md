...
| [ ] `P1.S1` | `todo` | Core README | `implementation` | `works/phases/active/P1/slices/P1.S1` |
| [ ] `P1.S2` | `todo` | Methodology & related projects | `implementation` | `works/phases/active/P1/slices/P1.S2` |
