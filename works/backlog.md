...
| [ ] `P3.S1` | `todo` | retrofit guide and durable docs | `docs` | `works/phases/active/P3/slices/P3.S1` |
| [ ] `P3.S2` | `todo` | installer into-existing retrofit mode | `implementation` | `works/phases/active/P3/slices/P3.S2` |
| [ ] `P3.S3` | `todo` | retrofit skill dual-applied | `implementation` | `works/phases/active/P3/slices/P3.S3` |
