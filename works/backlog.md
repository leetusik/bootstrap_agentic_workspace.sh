...
- Current phase: `P11`
- Current slice: `P11.S1`
- Next slice: `P11.S2`
- Waiting on operator: `none`
- Open deferred jobs: `0`
- Rebuilt at: `2026-07-28T03:48:32+09:00`
...
| [ ] `P11` | `planned` | `pending` | Free the orchestrator's idle window | `P11.S1` | `works/phases/active/P11` |
...
| [ ] `P11.S1` | `todo` | Drop slice-planner; make idle-window preparation optional | `implementation` | `works/phases/active/P11/slices/P11.S1` |
